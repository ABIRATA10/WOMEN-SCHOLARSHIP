    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start mb-6 relative z-10 gap-4">
        <div className="flex flex-wrap gap-2">
          {scholarship.country && (
            <span className="px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border bg-slate-100 text-slate-600 border-slate-200 flex items-center gap-1">
              <MapPin size={10} /> {scholarship.country}
            </span>
          )}
